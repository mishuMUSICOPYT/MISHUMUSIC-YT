    ...
    if replied:
        ...
        async for m in app.get_chat_members(message.chat.id):
            if message.chat.id not in SPAM_CHATS:
                break
            usernum += 1
            usertxt += f"\n⊚[{m.user.mantion}](tg://user?={m.user.id})\n"
            if usernum == 5:
        ...
        async for m in app.get_chat_members(message.chat.id):
            if message.chat.id not in SPAM_CHATS:
                break
            usernum += 1
            usertxt += f"\n⊚[{m.user.mantion}](tg://user?id={m.user.id})\n"
            if usernum == 5:
...
async def cancelcmd(_, message):
    ...
    if chat_id in SPAM_CHATS:
        ...
        await message.reply_text("ɴᴏ ᴘʀᴏᴄᴇss ᴏɢᴏɪɴɢ!")
        return
import asyncio
import random
...
TAGMES = [
    ...
    " 𝐀𝐚𝐩𝐤𝐚 𝐍𝐚𝐦𝐞 𝐊𝐲𝐚 𝐡𝐚𝐢..??🥲 ",
    " 𝐊𝐚𝐡𝐢 𝐏𝐲𝐚𝐫 𝐍𝐚 𝐇𝐨 𝐉𝐚𝐲𝐞 😁🤪 ",
    " 𝐊𝐞𝐬𝐢 𝐇𝐨 𝐌𝐞𝐫𝐢 𝐋𝐚𝐝𝐝𝐨 💞🥰 ",
    " 𝐀𝐩𝐧𝐚 𝐊𝐡𝐲𝐚𝐥 𝐑𝐚𝐤𝐡𝐧𝐚 𝐉𝐚𝐚𝐧 💓 ",
    " 𝐌𝐚𝐲 𝐢 𝐂𝐨𝐦𝐞 𝐈𝐧 𝐘𝐨𝐮𝐫 𝐇𝐞𝐚𝐫𝐭 😁🤪 ",
    " 𝐓𝐮𝐦 𝐀𝐣 𝐬𝐞 𝐓𝐮𝐦 𝐦𝐞𝐫𝐢 𝐁𝐚𝐧𝐝𝐢 🤪😁 ",
    " 𝐈 𝐋𝐨𝐯𝐞 𝐘𝐨𝐮 𝐛𝐞𝐛𝐨 💓🥰 ",
    " 𝐊𝐲𝐚 𝐌𝐞 𝐀𝐩𝐤𝐢 𝐄𝐤 𝐏𝐚𝐩𝐩𝐢 𝐥𝐞𝐥𝐮 😁",
    " 𝐂𝐡𝐚𝐥𝐨 𝐆𝐮𝐦𝐦𝐢 𝐊𝐚𝐫𝐭𝐞 𝐡𝐚𝐢 🥰 ",
    " 𝐍𝐚𝐬𝐭𝐚 𝐇𝐮𝐚 𝐀𝐚𝐩𝐤𝐚..??😋 ",
    ...
    " 𝐇𝐞𝐥𝐥𝐨 𝐉𝐢 𝐍𝐚𝐦𝐚𝐬𝐭𝐞😛 ",
    " 𝐇𝐞𝐥𝐥𝐨 𝐁𝐚𝐛𝐲 𝐊𝐤𝐫𝐡..?🤔 ",
    " 𝐌𝐞𝐫𝐞 𝐁𝐚𝐛𝐮 𝐍𝐞 𝐓𝐡𝐚𝐧𝐚 𝐓𝐡𝐚𝐲𝐚 ",
    " 𝐁𝐚𝐛𝐮 𝐌𝐢𝐥 𝐆𝐲𝐢 😁😘 ",
    " 𝐊𝐲𝐚 𝐌𝐞 𝐀𝐩𝐤𝐚 𝐃𝐢𝐥 𝐂𝐡𝐮𝐫𝐚 𝐋𝐮 😊 ",
    " 𝐊𝐞𝐬𝐢 𝐇𝐨 𝐁𝐚𝐧𝐝𝐚𝐫𝐢𝐲𝐚 ❤️😒 ",
    " 𝐊𝐚𝐡𝐚 𝐓𝐡𝐢 𝐈𝐭𝐧𝐞 𝐃𝐢𝐧 𝐒𝐞 😂😁 ",
    " 𝐀𝐣 𝐒𝐞 𝐓𝐮𝐦 𝐌𝐞𝐫𝐢 𝐁𝐡𝐚𝐛𝐡𝐢 𝐇𝐨 ",
    " 𝐀𝐣 𝐏𝐢𝐭𝐨𝐠𝐞 𝐓𝐮𝐦 😠🫤 ",
    " 𝐆𝐨𝐨𝐝 𝐀𝐟𝐭𝐞𝐫𝐧𝐨𝐨𝐧 ☺️ ",
    " 𝐔𝐟𝐟 𝐘𝐞 𝐀𝐝𝐚𝐲𝐞𝐢𝐧 ☺️ ",
    " 𝐌𝐞𝐫𝐢 𝐒𝐞𝐭𝐭𝐢𝐧𝐠 𝐊𝐫𝐰𝐚 𝐝𝐨 🥹🥹 ",
    " 𝐆𝐨𝐨𝐝 𝐌𝐨𝐫𝐧𝐢𝐠 𝐁𝐞𝐛𝐨𝐨 ",
    " 𝐀𝐣 𝐏𝐢𝐭𝐧𝐞 𝐊𝐚 𝐈𝐫𝐚𝐝𝐚 𝐇 𝐊𝐲𝐚 𝐓𝐮𝐦𝐡𝐚𝐫𝐚 😡 ",
    " 𝐔𝐭𝐡 𝐉𝐚 𝐀𝐥𝐬𝐢 ",
    " 𝐁𝐡𝐚𝐛𝐡𝐢 𝐉𝐢 𝐆𝐡𝐚𝐫 𝐩𝐚𝐫 𝐇𝐚𝐢 😁😂 ",
    " 𝐓𝐮 𝐍𝐚𝐥𝐥𝐚 𝐇𝐢 𝐌𝐚𝐫𝐞𝐠𝐚 😁🤣 ",
    " 𝐓𝐮𝐬𝐢 𝐁𝐚𝐝𝐞 𝐒𝐨𝐡𝐧𝐞 𝐨𝐨𝐡 ❤️🙈 ",
    " 𝐀𝐣 𝐒𝐞 𝐓𝐮 𝐌𝐞𝐫𝐢 𝐁𝐚𝐧𝐝𝐢 🥰😍 ",
    " 𝐆𝐨𝐩𝐢 𝐁𝐚𝐡𝐮 𝐊𝐞𝐬𝐢 𝐡𝐨 ",
    " 𝐃𝐨 𝐘𝐨𝐮 𝐊𝐧𝐨𝐰 𝐖𝐡𝐨 𝐈𝐬 𝐌𝐲 𝐎𝐰𝐧𝐞𝐫 [@𝐊𝐢𝐧𝐠].? ",
    ...
    " 𝐌𝐮𝐦𝐦𝐲 𝐀𝐚 𝐆𝐲𝐢 𝐊𝐲𝐚😆😆😆 ",
    " 𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩 𝐍𝐮𝐦𝐛𝐞𝐫 𝐃𝐞𝐝𝐨 𝐒𝐢𝐫𝐟 𝐒𝐭𝐚𝐭𝐮𝐬 𝐝𝐞𝐤𝐡𝐮𝐧𝐠𝐚 😁😁 ",
    ...
    " 𝐇𝐞𝐦𝐥𝐨𝐨🧐 ",
    " 𝐇𝐞𝐲 𝐍𝐢𝐛𝐛𝐢 😁 ",
    " 𝐑𝐞𝐩𝐥𝐲 𝐍𝐡𝐢 𝐃𝐞𝐭𝐞 𝐇𝐚𝐭𝐡 𝐓𝐮𝐭 𝐆𝐲𝐞 𝐲𝐚 𝐓𝐮𝐝𝐰𝐚𝐚𝐧𝐚 𝐂𝐡𝐚𝐡𝐭𝐞 𝐡𝐨 😐😠 ",
    " 𝐌𝐞𝐫𝐚 𝐁𝐚𝐛𝐮 𝐊𝐡𝐨 𝐆𝐲𝐚 😒 ",
    " 𝐌𝐮𝐣𝐡𝐞 𝐁𝐡𝐮𝐥 𝐆𝐲𝐞 𝐊𝐲𝐚🥺 ",
    " 𝐘𝐚𝐡𝐚 𝐀𝐚 𝐉𝐚𝐨:-[𝐊𝐢𝐧𝐠]  𝐌𝐚𝐬𝐭𝐢 𝐊𝐚𝐫𝐞𝐧𝐠𝐞 🤭🤭 ",
    ...
    " 𝐌𝐲 𝐂𝐮𝐭𝐞 𝐎𝐰𝐧𝐞𝐫{𝐊𝐢𝐧𝐠}🥰 ",
    " 𝐊𝐚𝐡𝐚 𝐊𝐡𝐨𝐲𝐞 𝐇𝐨 𝐉𝐚𝐚𝐧😜 ",
    " 𝐀𝐩𝐤𝐚 𝐅𝐚𝐯 𝐒𝐨𝐧𝐠 𝐤𝐨𝐧𝐬𝐚 𝐡 ",
    " 𝐇𝐥𝐨 𝐌𝐢𝐬𝐭𝐞𝐫 𝐈𝐧𝐝𝐢𝐚 𝐊𝐚𝐡𝐚 𝐠𝐚𝐲𝐚𝐛 𝐡𝐨 ",
    "𝐎𝚈𝙴 𝐕𝙲 𝐀𝙰𝙾 𝐍𝙰 𝐏𝙻𝚂🥲",
